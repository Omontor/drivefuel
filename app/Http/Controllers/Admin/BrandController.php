...
class BrandController extends Controller
{
    ...
    public function index()
    {
        ...
        $brands = Brand::with(['client', 'media'])->get();

        $clients = Client::get();

        return view('admin.brands.index', compact('brands', 'clients'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.brands.create', compact('clients'));
    }
    ...
    public function edit(Brand $brand)
    {
        ...
        return view('admin.brands.edit', compact('clients', 'brand'));
    }
    ...
    public function show(Brand $brand)
    {
        ...
        $brand->load('client', 'brandProjects');
